...
CREATE TABLE `fbc` (
  ...
  CONSTRAINT `cons_fk_fbc1` FOREIGN KEY (`report_id`) REFERENCES `report_details` (`report_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fbs` (
  ...
  PRIMARY KEY (`report_id`),
  CONSTRAINT `const_fk_fbs1` FOREIGN KEY (`report_id`) REFERENCES `report_details` (`report_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `medication` (
  ...
  CONSTRAINT `const_fk_med1` FOREIGN KEY (`patientId`) REFERENCES `patient_name` (`patientId`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `medication` VALUES ('570V','2017-01-15','Chylothorax or LCHAD ','20mg','After taking foods','Nisali  De Silva','ISSUED'),('570V','2017-01-15','Expecta® LIPIL® ','100mg','NONE','Nisali  De Silva','CANCELED'),('570V','2017-01-15','Paracetomol','20mg','NONE','Nisali  De Silva','CANCELED'),('570V','2017-01-16','Chylothorax or LCHAD ','34','','Nisali  De Silva','ISSUED'),('570V','2017-01-16','Penic','2','NONE','Nisali  De Silva','CANCELED'),('570V','2017-01-18','cbxfbxv','Dose 0',NULL,'Nisali  De Silva','NOT ISSUED'),('570V','2017-01-18','fg','Dose 0',NULL,'Nisali  De Silva','NOT ISSUED');
...
CREATE TABLE `observation` (
  ...
  CONSTRAINT `const_fk_obs1` FOREIGN KEY (`patientId`) REFERENCES `patient_name` (`patientId`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `observation_type` VALUES ('','0000-00-00','','',''),('570V','2017-01-15','Inpiratory Crepitations','Right Lower Zone','Fine'),('570V','2017-01-15','Lymphadenopathy','Right Axilliary',''),('570V','2017-01-15','Lymphadenopathy','Right Cervical',''),('570V','2017-01-16','Lymphadenopathy','Right Cervical','');
...
INSERT INTO `report_details` VALUES ('','','2017-01-18'),('SAMPLE151','REPORT151','2017-01-15'),('SAMPLE152','REPORT152','2017-01-15'),('SAMPLE2016','REPORT2016','2017-01-16');
...
INSERT INTO `session` VALUES ('2017-01-18 03:48:16','932790091V','OPD Doctor'),('2017-01-17 11:28:43','990450078V','Bleeding Room Nurse');
...
INSERT INTO `treatmentplan` VALUES ('570V','2017-1-15','Extrapulmonary tuberculosis','Referral to Respiratory Consultant','Dr Kirthi Gunasekara','NONE','Nisali  De Silva'),('570V','2017-1-16','Upper respiratory tract infection','Follow up OPD','Not Assigned','','Nisali  De Silva'),('570V','2017-1-18','Non specific symptoms','Discharge from OPD','Not Assigned','','Nisali  De Silva');
...
-- Dump completed on 2017-01-18 10:00:42
